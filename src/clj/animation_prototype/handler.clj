(ns animation-prototype.handler
  (:require
   [reitit.ring :as reitit-ring]
   [animation-prototype.middleware :refer [middleware]]
   [hiccup.page :refer [include-js include-css html5]]
   [config.core :refer [env]]))

(def mount-target
  [:div#app
   [:h2 "Welcome to animation-prototype"]
...
(defn loading-page []
  (html5
   ...
   [:body {:class "body-container"}
    ...
    [:script "animation_prototype.core.init_BANG_()"]]))
