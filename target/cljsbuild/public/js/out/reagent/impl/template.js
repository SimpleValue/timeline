...
var G__33466 = o;
goog.object.set(G__33466,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var args = cljs.core.seq(arglist__33469);
...
var G__33470 = o;
goog.object.set(G__33470,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__33471__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__33472__i < G__33472__a.length) {G__33472__a[G__33472__i] = arguments[G__33472__i + 0]; ++G__33472__i;}
  args = new cljs.core.IndexedSeq(G__33472__a,0,null);
} 
return G__33471__delegate.call(this,args);};
G__33471.cljs$lang$maxFixedArity = 0;
G__33471.cljs$lang$applyTo = (function (arglist__33473){
var args = cljs.core.seq(arglist__33473);
return G__33471__delegate(args);
});
...
var G__33474 = props;
var G__33474__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__33474,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__33474);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__33474__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__33474__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__33475 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__33475,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__33475;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__33476){
...
var on_write = cljs.core.get.call(null,map__33477__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__33479_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__33479_SHARP_);
}));
} else {
return null;
}
...
var vec__33482 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__33482,(0),null);
var id = cljs.core.nth.call(null,vec__33482,(1),null);
var className = cljs.core.nth.call(null,vec__33482,(2),null);
...
var temp__5739__auto___33486 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___33486 == null)){
} else {
var key_33487 = temp__5739__auto___33486;
(jsprops.key = key_33487);
}
...
var temp__5739__auto___33488 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___33488 == null)){
} else {
var key_33489 = temp__5739__auto___33488;
(jsprops.key = key_33489);
}
...
var temp__5739__auto___33490 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___33490 == null)){
} else {
var key_33491 = temp__5739__auto___33490;
(jsprops.key = key_33491);
}
...
var G__33493 = n;
if(cljs.core._EQ_.call(null,"",G__33493)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__33493)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq33494){
...
break;
default:
var G__33501 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__33501;
continue;
...
var ctx = ({});
var vec__33503 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__33503,(0),null);
var derefed = cljs.core.nth.call(null,vec__33503,(1),null);
...
var G__33506 = (cljs.core.count.call(null,argv) - first_child);
switch (G__33506) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1635172984034
