...
return cljs.core.reduce.call(null,(function (result,p__30189){
...
var vec__30193 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__30193,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__30193,(1),null);
var ab = cljs.core.nth.call(null,vec__30193,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_30199 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_30199.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_30200 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_30200.call(null,a,b);
}
});
...
return (function (){var G__30204 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30204__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1635172979029
