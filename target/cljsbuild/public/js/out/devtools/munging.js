...
var o31949 = temp__5733__auto__;
var temp__5733__auto____$1 = (o31949["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o31950 = temp__5733__auto____$1;
return (o31950["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__30727__auto__ = f;
return (o__30727__auto__["toString"]).call(o__30727__auto__);
} else {
return "";
}
}catch (e31951){var _ = e31951;
return "";
}});
...
try{var o__30727__auto___31953 = t;
(o__30727__auto___31953["cljs$lang$ctorPrWriter"]).call(o__30727__auto___31953,t,writer);
}catch (e31952){var __31954 = e31952;
}
...
var char_code = (function (){var o__30727__auto__ = (new String(char$));
return (o__30727__auto__["charCodeAt"]).call(o__30727__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__30727__auto__ = String;
return (o__30727__auto__["fromCharCode"]).call(o__30727__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__31955 = num_code;
switch (G__31955) {
case (1):
return (185);
...
var o__30727__auto__ = String;
return (o__30727__auto__["fromCharCode"]).call(o__30727__auto__,superscript_code);
});
/**
...
}catch (e31957){var _e__30734__auto__ = e31957;
return false;
}})())){
...
var vec__31958 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__31958,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__31963){
var vec__31964 = p__31963;
var ns_detector = cljs.core.nth.call(null,vec__31964,(0),null);
...
var G__31970 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__31971 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__31970;
remaining_tokens = G__31971;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq31961){
var G__31962 = cljs.core.first.call(null,seq31961);
var seq31961__$1 = cljs.core.next.call(null,seq31961);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31962,seq31961__$1);
}));
...
var vec__31975 = cljs.core.split_with.call(null,(function (p1__31974_SHARP_){
return cljs.core.not_EQ_.call(null,p1__31974_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__31975,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__31975,(1),null);
...
var vec__31981 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__31981,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__31981,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__31984 = cljs.core.rest.call(null,remaining_tokens);
var G__31985 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__31984;
name_tokens = G__31985;
continue;
} else {
...
var vec__31988 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__31988,(0),null);
var arity = cljs.core.nth.call(null,vec__31988,(1),null);
var vec__31991 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__31991,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__31991,(1),null);
var vec__31994 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__31994,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__31994,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__31994,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__31994,(3),null);
...
var vec__32000 = result;
var munged_ns = cljs.core.nth.call(null,vec__32000,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__32000,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__32000,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__32000,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__32000,(4),null);
var arity = cljs.core.nth.call(null,vec__32000,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__32004 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__32004,(0),null);
var args = cljs.core.nth.call(null,vec__32004,(1),null);
var vec__32007 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__32007,(0),null);
var name = cljs.core.nth.call(null,vec__32007,(1),null);
...
var G__32010 = (arity + (1));
var G__32011 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__32012){
var vec__32013 = p__32012;
var arity = cljs.core.nth.call(null,vec__32013,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__32013,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__32016_SHARP_){
return cljs.core.get.call(null,arities,p1__32016_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__32017_SHARP_){
return cljs.core.drop.call(null,(2),p1__32017_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___32024 = arguments.length;
var i__4737__auto___32025 = (0);
while(true){
if((i__4737__auto___32025 < len__4736__auto___32024)){
args__4742__auto__.push((arguments[i__4737__auto___32025]));

var G__32026 = (i__4737__auto___32025 + (1));
i__4737__auto___32025 = G__32026;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__32020){
var vec__32021 = p__32020;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__32021,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq32018){
var G__32019 = cljs.core.first.call(null,seq32018);
var seq32018__$1 = cljs.core.next.call(null,seq32018);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32019,seq32018__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__32029__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__32029__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__32029__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__32029__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__32030 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__32030,(0),null);
var fn_name = cljs.core.nth.call(null,vec__32030,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__32030,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__32030,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__32030,(4),null);
var arity = cljs.core.nth.call(null,vec__32030,(5),null);
...
var o__30727__auto__ = f;
return (o__30727__auto__["getBasis"]).call(o__30727__auto__);
});
/**
...
}catch (e32034){var _e__30734__auto__ = e32034;
...
var G__32035 = (obj[cljs.core.first.call(null,path)]);
var G__32036 = cljs.core.rest.call(null,path);
obj = G__32035;
path = G__32036;
continue;
} else {
...
var _STAR_ = (function (accum,p__32037){
var vec__32038 = p__32037;
var bit = cljs.core.nth.call(null,vec__32038,(0),null);
var protocol = cljs.core.nth.call(null,vec__32038,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__32041){
var vec__32042 = p__32041;
var ns = cljs.core.nth.call(null,vec__32042,(0),null);
var name = cljs.core.nth.call(null,vec__32042,(1),null);
var selector = cljs.core.nth.call(null,vec__32042,(2),null);
...
var post_process = (function (p__32046){
var vec__32047 = p__32046;
var munged_name = cljs.core.nth.call(null,vec__32047,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__32047,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__32045_SHARP_){
return (obj[cljs.core.first.call(null,p1__32045_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1635172981414
