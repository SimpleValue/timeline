...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32124){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32125,G__32126,seq32124__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32130_SHARP_){
return (!((cljs.core.meta.call(null,p1__32130_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__32131__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32135){var _e__30734__auto__ = e32135;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e32137){var _e__30734__auto__ = e32137;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__32139 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__32140 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__32140);

try{var map__32141 = opts;
...
var markup_db = cljs.core.get.call(null,map__32141__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__32139);
}});
...
var temp__5733__auto___32146 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___32146)){
var managed_print_level_32147 = temp__5733__auto___32146;
var _STAR_print_level_STAR__orig_val__32144_32148 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__32145_32149 = managed_print_level_32147;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__32145_32149);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__32143_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__32143_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__32144_32148);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1635172981739
