...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_34119 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_34119.call(null,port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_34120 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_34120.call(null,port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_34121 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_34121.call(null,chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_34122 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_34122.call(null,chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_34123 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_34123.call(null,h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_34124 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_34124.call(null,h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_34125 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_34125.call(null,h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_34126 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_34126.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_34127 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_34127.call(null,b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_34128 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_34128.call(null,b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_34129 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_34129.call(null,b);
}
});
...
//# sourceMappingURL=protocols.js.map?rel=1635172985069
